...
def freqMat(data, data_sub):
    ...
    file = open("frequentwords.txt", "w")
    file.close()

    text_dataframe.to_csv('frequentwords.txt', sep=' ')
    ...
    print("the topic word for first folder is : ", title1)
    ...
    print("the topic word for second folder is : ", title2)
    ...
    print("the topic word for third folder is : ", title3)
