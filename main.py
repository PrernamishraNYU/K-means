...
from frequencymatrix import freqMat
import spacy
...
if __name__ == '__main__':
    ...
    print("The most frequent words in NGRAMS are :", ngrams)

    print("-"*60)
    print("\n")
    matrix, tf_idf, sub_data = freqMat(passing, combined_list)

    print("-"*60)

    kmean_cluster = Kmeans(k=3,  max_iter=100) #By default 200
    ...
    print("-" * 60)
    print("\n")
    # Visualizing the clusters wrt pca analysis
